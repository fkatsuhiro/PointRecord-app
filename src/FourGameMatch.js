/*スコア・統計データカウント用コンポーネント(1セット4ゲームの3セットマッチ)*/
...
class FourGameMatch extends React.Component {
    //初期状態
    constructor(props) {
        super(props);
        this.state = {
